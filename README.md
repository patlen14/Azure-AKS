...
| 2.   | [Docker Fundamentals](https://github.com/Azure-AKS/docker-fundamentals) |
...
| ----------------- | ----------------- |
| Simple Nginx V1  | Azure-AKS/kubenginx:1.0.0  |
| Spring Boot Hello World API  | Azure-AKS/kube-helloworld:1.0.0  |
| Simple Nginx V2  | Azure-AKS/kubenginx:2.0.0  |
| Simple Nginx V3  | Azure-AKS/kubenginx:3.0.0  |
| Simple Nginx V4  | Azure-AKS/kubenginx:4.0.0  |
| Backend Application  | Azure-AKS/kube-helloworld:1.0.0  |
| Frontend Application  | Azure-AKS/kube-frontend-nginx:1.0.0  |
| Kube Nginx App1  | Azure-AKS/kube-nginxapp1:1.0.0  |
| Kube Nginx App2  | Azure-AKS/kube-nginxapp2:1.0.0  |
| User Management Web Application  | Azure-AKS/kube-usermgmt-webapp:1.0.0-MySQLDB  |
